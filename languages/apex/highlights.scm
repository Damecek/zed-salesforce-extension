...
;; Avoid over-highlighting identifiers in nested contexts (e.g. SOQL/SOSL bodies).
...
;; ---
;; Embedded SOQL/SOSL highlighting
;;
;; tree-sitter-sfapex's `apex/tree-sitter.json` lists SOQL/SOSL highlight queries as part of the
;; Apex language. Zed loads highlights from a single `languages/apex/highlights.scm`, so we
;; inline the upstream SOQL/SOSL queries here to get highlighting inside `[ ... ]` blocks.
;; ---
